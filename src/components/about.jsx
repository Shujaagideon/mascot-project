...
const About = () => {
  return (
    <>
        ...
        <div className="h-screen fixed z-20 w-full p-5 lg:p-20 bg-transparent flex overflow-hidden">
            <div className="w-full md:w-2/5 h-4/5 text-slate-100 backdrop-blur-md ml-auto mt-auto border border-slate-100 rounded-xl p-10">
