  ...
  return (
    <>
        ...
        <div className="h-screen fixed z-20 w-full p-2 md:p-5 lg:p-20 bg-transparent flex overflow-hidden">
            <div className="w-full overscroll-y-scroll md:w-4/5  xl:w-2/5 h-4/5 text-slate-100 backdrop-blur-md ml-auto mt-24 text-sm md:text-base md:mt-auto border border-slate-100 rounded-xl p-4 md:p-10">
