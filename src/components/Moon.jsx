...
export function Moon({name, opacity, hovered:hoverState}) {
  ...
  // useEffect(()=>{
  //   // clone.color = new THREE.Color(hoverState);
  //   clone.needsUpdate = true;
  //   // clone.color = hoverState ? new THREE.Color('#fff'): new THREE.Color('#888');
  // },[hoverState, clone])
  const hello2 = ()=>{
